package com.eardwulf.wickednature.init.blocks.trees;

import java.util.Random;

import javax.annotation.Nullable;

import com.eardwulf.wickednature.util.IMetaName;
import com.eardwulf.wickednature.world.feature.tree.WorldGenTutorialTree;
...
{	
    ...
    public CustomBlockSapling(String name) 
    {
		...
		this.setDefaultState(this.blockState.getBaseState().withProperty(VARIANT, CustomBlockPlanks.EnumType.ARCANE).withProperty(STAGE, Integer.valueOf(0)));
	}
