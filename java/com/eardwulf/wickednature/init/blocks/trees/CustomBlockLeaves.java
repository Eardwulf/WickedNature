...
public class CustomBlockLeaves extends BlockLeaves implements IMetaName
{
	...
	public CustomBlockLeaves(String name) 
	{
		...
		setDefaultState(this.blockState.getBaseState().withProperty(VARIANT, CustomBlockPlanks.EnumType.ARCANE).withProperty(CHECK_DECAY, Boolean.valueOf(true)).withProperty(DECAYABLE, Boolean.valueOf(true)));
	}
