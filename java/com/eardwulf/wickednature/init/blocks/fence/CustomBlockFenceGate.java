package com.eardwulf.wickednature.init.blocks.fence;
...
public class CustomBlockFenceGate extends BlockHorizontal
{
    ...
    public CustomBlockFenceGate(String name, float hardness, float resistance)
    {
