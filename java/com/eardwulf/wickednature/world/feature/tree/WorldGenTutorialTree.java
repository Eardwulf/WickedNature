package com.eardwulf.wickednature.world.feature.tree;
...
public class WorldGenTutorialTree extends WorldGenAbstractTree 
{
	public static final IBlockState LOG = BlockInit.log.getDefaultState().withProperty(CustomBlockLog.VARIANT, CustomBlockPlanks.EnumType.BLOOD);
	public static final IBlockState LEAF = BlockInit.leaves.getDefaultState().withProperty(CustomBlockLeaves.VARIANT, CustomBlockPlanks.EnumType.ARCANE);
